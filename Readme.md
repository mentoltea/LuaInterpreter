...
---
Особенности
* При вызове `pcall` экзекуция будет происходит до возвращения из переданной функции. По этой причине внутри вызова **НЕЛЬЗЯ** передавать котроль выполнения, то есть вызывать `coroutine.resume`, поскольку это может привести к UB.
